...
class ControllerExtensionModuleOctabcategoryslider extends Controller {
	public function index($setting) {
		...
		$cover_image =  $this->model_tool_image->resize($setting['image'], 237, 384);
		$cover_image2 =  $this->model_tool_image->resize($setting['image'], 280, 480);
		$cover_image3 =  $this->model_tool_image->resize($setting['image'], 270, 646);
		$cover_image4 =  $this->model_tool_image->resize($setting['image'], 370, 580);
