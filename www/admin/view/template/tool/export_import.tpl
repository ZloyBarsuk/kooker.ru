...
<div id="content">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<ul class="nav nav-tabs">
					...
					<li ><a href="#tab-export-berghoff" data-toggle="tab"><?php echo $tab_export_berghoff; ?></a></li>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="tab-export-berghoff">
						<form action="<?php echo $export_berghoff; ?>" method="post" enctype="multipart/form-data" id="export-berghoff" class="form-horizontal">
							<table class="form">
								<tr>
									<td><?php echo $entry_export; ?></td>
								</tr>
								...
								<tr>
									<td style="vertical-align:top;">
										<span >	<?php echo "Ссылка на сайт бергофа для получения XML-файла"; ?></span>
										<br />
										<input type="text" name="xml_link" value="http://b2b.berghoffworldwide.ru/catalog_xml_export/"  style="width:300px;"/>
									</td>
								</tr>

								<tr>
									<td class="buttons"><a onclick="downloadDataBerghoff();" class="btn btn-primary"><span><?php echo $button_export_berghoff; ?></span></a></td>
								</tr>
							</table>
						</form>
					</div>
	...
	<script type="text/javascript"><!--
        ...
        function downloadDataBerghoff() {
            if (validateExportForm('export-berghoff')) {
                $('#export-berghoff').submit();
            }
        }
